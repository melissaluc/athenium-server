            ...
            const returnData = {
                body_composition:{
                    delta:{
                        ...
                        delta_muscle_mass:{label:"Muscle Mass", value:deltaBodyComp.muscleMass.toFixed(2), uom:userUom[0].uom}
                    },
                    params:{
                        ...
                        current_muscle_mass:{label:"Muscle Mass", value:bodyComposition[0].lean_muscle_mass, uom:userUom[0].uom}
                    },
